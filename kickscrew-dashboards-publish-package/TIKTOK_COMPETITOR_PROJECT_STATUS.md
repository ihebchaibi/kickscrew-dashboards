...
- `index.html` is a local launcher.
- `competitor-tiktok-dashboard.html` is the cleaned global dashboard.
- `gcc-competitor-tiktok-dashboard.html` is the cleaned regional dashboard.
- `tiktok-competitor-data.js` is the single shared data source for both dashboards.
- `tiktok-dashboard.js` renders filters, tables, cards, anomaly notes, and spend bars.
...
The dashboards work locally without Chart.js, external image links, or CDN dependencies.
